  ...
  projects: [
    {
      ...
      tech: ["React", "Next.js", "TypeScript", "Stripe", "Auth0", "PostgreSQL / Prisma"],
      desc: "A modern, full-stack e-commerce platform built with React and Next.js. Features seamless end-to-end payment processing with Stripe, robust Auth0 integration for secure user authentication, and type-safe database management using Prisma.",
      image: "/AmazShop_Homepage.png",
      images: ["/AmazShop_Homepage.png", "/Amaz_PLP.png", "/Amaz_cart.png"],
      liveLink: "https://amaz-shop-o16x.vercel.app/",
...
export const CHAT_RESPONSES = {
  ...
  projects: `Key projects: AmazShop — a full-stack MERN e-commerce platform with JWT auth and payment integration (live at amaz-shop-o16x.vercel.app). QueMates — a social platform for student-teacher academic collaboration with real-time Socket.io interactions.`,
